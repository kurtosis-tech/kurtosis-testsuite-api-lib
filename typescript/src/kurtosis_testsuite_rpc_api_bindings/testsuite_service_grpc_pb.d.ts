...
interface ITestSuiteServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  registerFilesArtifacts: grpc.MethodDefinition<testsuite_service_pb.RegisterFilesArtifactsArgs, google_protobuf_empty_pb.Empty>;
...
export interface ITestSuiteServiceServer extends grpc.UntypedServiceImplementation {
  ...
  registerFilesArtifacts: grpc.handleUnaryCall<testsuite_service_pb.RegisterFilesArtifactsArgs, google_protobuf_empty_pb.Empty>;
...
export class TestSuiteServiceClient extends grpc.Client {
  ...
  registerFilesArtifacts(argument: testsuite_service_pb.RegisterFilesArtifactsArgs, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  registerFilesArtifacts(argument: testsuite_service_pb.RegisterFilesArtifactsArgs, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  registerFilesArtifacts(argument: testsuite_service_pb.RegisterFilesArtifactsArgs, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
